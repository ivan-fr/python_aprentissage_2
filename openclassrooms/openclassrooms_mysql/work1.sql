...
add constraint fk_commentaire_article_id foreign key (article_id) references articles(id) on delete cascade,
add constraint fk_commentaire_utilisateur_id foreign key (utilisateur_id) references utilisateurs(id) on delete cascade;

alter table Categorie_article
modify categorie_id smallint unsigned not null,
modify article_id smallint unsigned not null,
add constraint fk_categorie_article_categorie_id foreign key (categorie_id) references Categorie(id) on delete set null,
